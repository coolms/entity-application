...
[![CI](https://github.com/coolms/entity-app/actions/workflows/ci.yml/badge.svg)](https://github.com/coolms/entity-app/actions/workflows/ci.yml)
[![Latest Version](https://img.shields.io/packagist/v/coolms/entity-app)](https://packagist.org/packages/coolms/entity-app)
...
> adapter provides it, so `composer require coolms/entity-app` on its own
